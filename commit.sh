...
git pull https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/PowerBI/_git/pbi-cicd-test
...
git push --force https://$AZUSERNAME:$AZUREPAT@dev.azure.com/$AZORG/PowerBI/_git/pbi-cicd-test